...
import { Train, Clock, ArrowRight, Calendar, MapPin } from 'lucide-react-native';
import { MotiView } from 'moti';

const ConnectingTrainCard = ({ train, onPress }) => {
  ...
  const renderTimeBlock = (time, station, type) => (
    <View style={[
      styles.timeBlock,
      isSmallScreen && styles.timeBlockSmall
    ]}>
      <Text style={[
        styles.time,
        isSmallScreen && styles.timeSmall
      ]}>{time}</Text>
      <View style={styles.stationContainer}>
        <MapPin size={isSmallScreen ? 14 : 16} color="#808080" style={styles.stationIcon} />
        <Text style={[
          styles.station,
          isSmallScreen && styles.stationSmall
        ]} numberOfLines={2}>{station}</Text>
      </View>
      <Text style={[
        styles.timeLabel,
  ...
  const renderHeader = () => (
    <View style={[
      ...
      <View style={styles.trainInfo}>
        ...
        <Text style={[
          styles.trainNumber,
          isSmallScreen && styles.trainNumberSmall
        ]}>{trainNumber}</Text>
        <Text style={[
          styles.trainName,
          isSmallScreen && styles.trainNameSmall
        ]} numberOfLines={1}>{trainName}</Text>
      </View>
      <View style={[
        styles.statusBadge,
  ...
  const renderJourneyDetails = () => (
    <View style={[
      ...
      isSmallScreen && styles.journeyContainerSmall
    ]}>
      ...
      <View style={styles.journeyLine}>
        ...
        <View style={[
          ...
          isSmallScreen && styles.durationBadgeSmall
        ]}>
          <Clock size={isSmallScreen ? 12 : 14} color="#FFFFFF" />
          <Text style={[
            styles.durationText,
            isSmallScreen && styles.durationTextSmall
          ]}>{duration}</Text>
        </View>
    ...
    <View style={[
      ...
      <TouchableOpacity 
        style={[
          ...
          isSmallScreen && styles.detailsButtonSmall
        ]}
      >
        <Text style={[
          styles.detailsButtonText,
          isSmallScreen && styles.detailsButtonTextSmall
        ]}>View Details</Text>
      </TouchableOpacity>
    </View>
  );
...
export default ConnectingTrainCard;